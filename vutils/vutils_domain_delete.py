...
DOCUMENTATION = '''
---
module: vutils_domain_delete
short_description: delete KVM domain
...
EXAMPLES = '''
- name: delete KVM domain
  vutils_domain_delete:
    name : "{{ name }}"
'''
...
def main():
    ...
    result = vutils_cmd._run_cmd(module, 'domain_delete')
